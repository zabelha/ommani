...
object NotificationUtil {
    ...
    fun create(id: Int, intent: Intent, titulo: String, texto: String){
        ...
        with(NotificationManagerCompat.from(OmmaniAplication.getInstance())) {
            val n = builder.build()
            notify(id, n)
        }
    }
